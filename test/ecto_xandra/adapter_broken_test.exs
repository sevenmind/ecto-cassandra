defmodule EctoXandra.AdapterBrokenTest do
  ...
  alias EctoXandra.Adapter.Connection, as: SQL
  ...
  defmodule Schema do
    ...
    schema "schema" do
      ...
      has_many(:comments, EctoXandra.AdapterTest.Schema2,
        references: :x,
        foreign_key: :z
      )

      has_one(:permalink, EctoXandra.AdapterTest.Schema3,
        references: :y,
        foreign_key: :id
      )
    end
  ...
  defmodule Schema2 do
    ...
    schema "schema2" do
      belongs_to(:post, EctoXandra.AdapterTest.Schema,
        references: :x,
        foreign_key: :z
      )
    end
  ...
  defp plan(query, operation \\ :all) do
    {query, _params} = Ecto.Adapter.Queryable.plan_query(operation, EctoXandra.Adapter, query)
    query
  end
